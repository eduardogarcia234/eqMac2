...
+(NSImage *)convertImageToGrayScale:(NSImage *)image {
    ...
    CGContextDrawImage(context, imageRect, [image CGImageForProposedRect:&imageRect context:NULL hints:nil]);
    ...
    NSImage *newImage = [[NSImage alloc] initWithCGImage:imageRef size:NSZeroSize];
